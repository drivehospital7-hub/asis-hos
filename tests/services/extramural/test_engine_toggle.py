"""Strict TDD: Tests for engine toggle in extramural/detect_all.py.
...
class TestExtramuralEngineToggle:
    """Tests for the engine toggle in detect_all_problems_extramural."""
