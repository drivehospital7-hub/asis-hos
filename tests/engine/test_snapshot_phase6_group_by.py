...
# NOTE (remate borrado fase 3): clase TestDobleTipoProcedimientoEngineVsLegacy
# eliminada completa (6 tests) — cada test importaba el módulo legacy borrado
# app/services/transversales/doble_tipo_procedimiento.py. Quedan los tests de
# engine puro (TestRevisionCantidadEngine, TestPhase6OutputFormat).
