...
// const initialData = (window as unknown as { __INITIAL_DATA__?: EbData }).__INITIAL_DATA__;
...
export function EquiposBasicosPage() {
  ...
  const handleProcesar = async () => {
    ...
    try {
      ...
      const res = await fetch("/odontologia-equipos-basicos/", { method: "POST", body: fd });
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <Breadcrumbs items={[{ label: "Equipos Básicos" }]} />
      <PageTitle
        eyebrow="Equipos Básicos"
        title="Consumos y Servicios"
        description="Carga el reporte detallado de equipos básicos en formato Excel para validar los registros y detectar inconsistencias."
      />
      ...
      <Card className="p-6 border-border bg-card shadow-none mb-6">
        ...
        {showRules && (
          <div className="mt-4 rounded-md border border-border bg-muted/30 p-4">
            <h3 className="font-display font-semibold text-foreground mb-3">Reglas de Validación - Equipos Básicos</h3>
