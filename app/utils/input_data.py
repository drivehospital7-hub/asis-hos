...
from app.constants import ALLOWED_EXCEL_SUFFIXES, MAX_EXCEL_UPLOAD_SIZE_MB
...
def save_temp_excel(file_storage) -> tuple[Path | None, str | None]:
    ...
    if size_bytes > MAX_EXCEL_UPLOAD_SIZE_MB * 1024 * 1024:
        return None, f"Archivo excede el tamaño máximo de {MAX_EXCEL_UPLOAD_SIZE_MB}MB"
