-- =============================================================================
-- Phase 4: centro_costo_urgencias_valido
-- Rule: Flag invoices where centro_costo is NOT in the valid Urgencias list.
-- Domain: urgencias
...
SELECT 'centro_costo_urgencias_valido', 'Centro de costo no válido en Urgencias', 'urgencias', 'active', 1, 25, 'error', true
WHERE NOT EXISTS (
    SELECT 1 FROM reglas WHERE nombre = 'centro_costo_urgencias_valido' AND version = 1
);
