...
export const Route = createFileRoute("/abiertas-urgencias")({
  head: () => ({
    meta: [
      { title: "Abiertas Urgencias · Hospital Orito" },
      { name: "description", content: "Gestión de horarios y responsables del servicio de urgencias." },
      { property: "og:title", content: "Abiertas Urgencias · Hospital Orito" },
      { property: "og:description", content: "Gestión de horarios y responsables del servicio de urgencias." },
    ],
  }),
  component: AbiertasUrgenciasPage,
});

function AbiertasUrgenciasPage() {
    ...
    <div className="mx-auto max-w-5xl">
      ...
      <Card className="border-border bg-card shadow-none mb-4 overflow-hidden">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-display font-semibold text-foreground">Asignar responsable desde horario</h3>
      ...
      <Card className="border-border bg-card shadow-none mb-4 overflow-hidden">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-display font-semibold text-foreground">Ver horario</h3>
      ...
      <Card className={cn(
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-display font-semibold text-foreground">Falta cargar el horario</h3>
            <p className="text-sm text-muted-foreground mt-0.5">
              No hay horario para el mes actual. Usa “Cargar” para agregar los turnos del mes.
            </p>
          </div>
